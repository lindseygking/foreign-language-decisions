...
# Methods
The current study seeks to replicate the figures and analyses used in @geipelForeignLanguageEffect2015. This study assessed the foreign language effect on moral judgement by presenting participants with the footbridge and trolley dilemma. A non-moral dilemma was designed to test for understanding in the foreign language. If it was understood, it should have high endorsements in all conditions [@geipelForeignLanguageEffect2015]. Two foreign language conditions were included (both English and German) to test if the effect is generalizable across languages.
...
# Discussion
Figure\ \@ref(fig:Proficiency) was generated as an inquiry of language proficiency for those in the foreign language condition. I was curious to see if there was any difference in consequentialism as individuals become more proficienct in their foreign language. I theorized that if a difference were to exist, individuals may become more consequential the more proficient they are in the foreign language. This is because they may be speaking the language more fluently thus relying less on translating materials to their native language in their mind thus eliminating the foreign language effect. The figure shows that this does not seem to be the case. This makes sense because individuals assigned to a foreign language condition were not ranked below a six in proficiency which was ranked from one to ten. This means participants were all decently proficient in their foreign language. We can also tell this from the results of the non-moral dilemma which was designed to elicit a high consequentialist response rate when understood properly. This was the case in these participants as seen in the non-moral dilemma means in Table\ \@ref(tab:demographic-table). 
